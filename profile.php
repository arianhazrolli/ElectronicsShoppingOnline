...
<html lang="en">
	<head>
		...
		<title>Beep electronics - Profile </title>
	        ...
	        <div class="row">
	        	<div class="col-sm-9">
	        		...
	        		<div class="box box-solid">
	        			<div class="box-body">
	        				<div class="col-sm-3">
	        					<img src="<?php echo (!empty($user['photo'])) ? 'images/'.$user['photo'] : 'images/profile.jpg'; ?>" width="70%">
	        				</div>
	        				<div class="col-sm-9">
	        					<div class="row">
								<div class="col-sm-9">
	        		...
	        		<div class="box box-solid">
	        			<div class="box-header with-border" class="table table-bordered">
